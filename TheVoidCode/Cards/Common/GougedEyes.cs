...
public sealed class GougedEyes() : TheVoidCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
    ...
    [
        ...
        new DamageVar(Constants.DynamicVars.BlindedDamage, 12m, ValueProp.Move)
    ];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var damage = Owner.Creature.HasBlind() ? DynamicVars[Constants.DynamicVars.BlindedDamage].BaseValue : DynamicVars.Damage.BaseValue;
    ...
    protected override void OnUpgrade()
    {
        ...
        DynamicVars[Constants.DynamicVars.BlindedDamage].UpgradeValueBy(4m);
    }
}